...
final class DisableTest extends DbWebTestCase
{
    ...
    {
        $this->client->request('POST', '/panel/solidcp/enterprise-dispatchers/' . EnterpriseDispatcherFixture::EXISTING_ID_ENABLED . '/disable');
    ...
    public function testDisable(): void
    {
        ...
        $this->client->request('POST', '/panel/solidcp/enterprise-dispatchers/' . EnterpriseDispatcherFixture::EXISTING_ID_ENABLED . '/disable', ['token' => $csrfToken]);
        $this->assertSame(302, $this->client->getResponse()->getStatusCode());
