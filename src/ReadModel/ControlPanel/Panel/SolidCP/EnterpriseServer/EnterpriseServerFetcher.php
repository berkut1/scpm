...
namespace App\ReadModel\ControlPanel\Panel\SolidCP\EnterpriseServer;
...
class EnterpriseServerFetcher
{
    ...
    {
        /** @var EnterpriseServer $enterpriseServer */
        if (!$enterpriseServer = $this->repository->findOneBy(['isDefault' => true])) {
            throw new NotFoundException('EnterpriseServer is not found');
        }
    ...
    public function allList(): array
    {
        $stmt = $this->connection->createQueryBuilder()
            ...
            ->from('cp_solidcp_enterprise_servers')
            ->orderBy('name')
